          ...
          <div className="text-white">
            ...
            <ul className="space-y-3">
               <li className="flex items-center text-lg gap-3">
                ...
                <span>Compare top NZ main insurers</span>
              </li>
               <li className="flex items-center text-lg gap-3">
  ...
  const sections = [
    {
      ...
      description: "Providers rate occupation, main, and age differently. A quick comparison can shave dollars off your monthly premium.",
      icon: Banknote,
            ...
            <div className="container mx-auto px-4 pt-16 pb-8">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-black">
                  Why compare main insurance quotes before you decide
                </h2>
              </motion.div>
            </div>
                    ...
                    <div className="lg:col-span-3 space-y-8">
                        ...
                        >
                            <h2 className="text-3xl md:text-4xl font-bold mb-4">
                                ...
                                main insurance isn't always the{' '}
                                <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
                                    best deal
                                </span>
                            </h2>
...
{(() => {
                        ...
                        >
                            ...
                            >
                                <p className="text-sm text-gray-600 font-medium">
                                    💡 For $20 more monthly, save hundreds per year on routine maincare
                                </p>
                            </motion.div>
                ...
                >
                    ...
                    <p className="text-xs text-gray-400 mt-4 max-w-2xl mx-auto">
                        *Figures are illustrative; your premium depends on age, main status, location, and chosen coverage level.
                    </p>
                </motion.div>
            </div>
        </section>
...
const MythBustingSection = () => {
    ...
    const myths = [
        {
            myth: "Main insurance is too expensive",
        ...
        {
            myth: "I'm young and mainy, I don't need it",
            truth: "Accidents happen at any age. Join while mainy for lifetime benefits.",
        ...
        {
            myth: "Public maincare covers everything",
...
{(() => {
                ...
                >
                    <p className="text-lg text-gray-600 mb-6">
                        Ready to separate facts from fiction about your main insurance options?
                    </p>
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent mb-4">
                        How our NZ main insurance comparison works
                    </h2>
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Get personalized main insurance recommendations in 4 simple steps
                    </p>
                </motion.div>
                ...
                >
                    <p className="text-lg text-gray-600 mb-6">
                        Ready to find your perfect main insurance match?
                    </p>
                    <motion.div
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
...
const StoriesSection = () => {
    ...
    const stories = [
        { 
            ...
            story: "Needed surgery for a sports injury. Private main insurance meant I got treatment within 2 weeks instead of waiting 6 months publicly.",
        ...
        { 
            ...
            story: "Comprehensive cover includes dental and optical. Saves me $2000+ annually on regular main expenses.",
                                        ...
                                        {activeStory < stories.length ? (
                                            ...
                                            >
                                                ...
                                                <p className="text-gray-600 mb-6">
                                                    Join thousands of Kiwis who found their perfect main insurance with our help.
                                                </p>
                                                <motion.div
                                                    whileHover={{ scale: 1.05 }}
                                                    whileTap={{ scale: 0.95 }}
    ...
    const benefits = [
        {
            ...
            description: "A handpicked selection of main insurance options from top NZ insurers tailored to your needs",
            gradient: "from-purple-500 to-pink-500",
            bgGradient: "from-purple-50 to-pink-50",
        ...
        },
        {
            ...
            description: "We highlight the best value options based on your main priorities, not just the cheapest price",
        ...
        },
        {
            ...
            description: "Personal advice from licensed main insurance advisers at no extra cost to you",
            gradient: "from-green-500 to-teal-500",
            bgGradient: "from-green-50 to-teal-50",
        ...
        <section ref={sectionRef} className="relative bg-gradient-to-br from-white via-purple-50/30 to-indigo-50/50 py-16 sm:py-24 overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        More than just quotes – a complete main insurance experience designed around you
                    </p>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6 max-w-md mx-auto">
                            Get personalized main insurance recommendations that actually make sense for your life and budget.
                        </p>
    ...
    return (
        <section className="bg-primary text-white py-16 sm:py-24">
            <div className="container mx-auto px-4 text-center max-w-7xl">
                <h2 className="text-3xl font-bold mb-2">Ready to find the right main insurance?</h2>
...
const FaqSection = () => {
    const faqs = [
        { q: "What happens after I submit my details?", a: "We'll review your information, compare plans from top NZ main insurers, and a dedicated adviser will contact you with tailored options. No instant quotes - we provide personalized recommendations." },
        { q: "Is the cheapest main insurance always best?", a: "Not necessarily. The cheapest often has the most exclusions and longest waiting periods. We help you find the best value - the right coverage for your budget." },
        ...
        { q: "Can I get cover if I have main conditions?", a: "Often yes, but conditions may be excluded or have longer waiting periods. Some insurers are more flexible than others - we'll find your best options." },
        { q: "Do I need a medical exam?", a: "Depends on your age, main, and level of cover. Many applications are based on main questionnaires. We'll explain requirements upfront." },
        { q: "Can I cancel anytime?", a: "Most policies can be cancelled with 30 days notice. However, if you cancel and re-join later, you may face new waiting periods and main assessments." },
    ];

    return (
        <section className="bg-gray-50 py-16 sm:py-24">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold text-primary text-center mb-8">Main insurance FAQs (NZ)</h2>

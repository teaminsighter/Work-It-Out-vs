...
const QuoteWizardMortgage = dynamic(() => import('@/components/quote/QuoteWizardMortgage'), {
  loading: () => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="text-white">
            ...
            <p className="text-lg md:text-xl text-white mb-8 max-w-xl text-shadow">
              Find the right mortgage protection for your home. Compare plans from leading NZ providers and get expert guidance.
            </p>
            <ul className="space-y-3">
               <li className="flex items-center text-lg gap-3">
                <Search className="h-6 w-6 text-green-400" />
                <span>Compare top NZ mortgage insurers</span>
              </li>
               <li className="flex items-center text-lg gap-3">
  ...
  const sections = [
    {
      ...
      description: "Providers rate property value, mortgage amount, and occupation differently. A quick comparison can shave dollars off your monthly premium.",
      icon: Banknote,
      color: "text-purple-600"
    },
    {
      title: "Benefit periods matter.",
      description: "Two 'mortgage protection' quotes can behave very differently — think full vs reducing cover, waiting periods, and payout definitions.",
      icon: Heart,
      color: "text-purple-600"
    },
    {
            ...
            <div className="container mx-auto px-4 pt-16 pb-8">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-black">
                  Why compare mortgage protection quotes before you decide
                </h2>
              </motion.div>
            </div>
    ...
    const warningPoints = [
        {
            ...
            icon: ShieldX,
            title: "Coverage gaps",
            description: "Basic policies might exclude certain circumstances or have reducing cover amounts that don't match your mortgage balance.",
            detail: "You could face insufficient payout to cover your remaining mortgage"
        },
        {
            id: 2,
            icon: Timer,
            ...
            detail: "Death or disability may not be covered immediately after signing up"
        },
        {
            id: 3,
            icon: TrendingDown,
            title: "Benefit limits",
            description: "Low-cost plans may cap your mortgage benefits, leaving you exposed if you have a large mortgage.",
            detail: "Coverage limits may be much lower than your actual mortgage balance"
        }
    ];
                    ...
                    <div className="lg:col-span-3 space-y-8">
                        ...
                        >
                            <h2 className="text-3xl md:text-4xl font-bold mb-4">
                                ...
                                mortgage insurance isn't always the{' '}
                                <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
                                    best deal
                                </span>
                            </h2>
...
{(() => {
                        ...
                        >
                            ...
                            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
                                ...
                                <div className="grid grid-cols-2 divide-x divide-gray-200">
                                    ...
                                    <div className="p-6 bg-gradient-to-br from-red-50 to-orange-50">
                                        <div className="text-center mb-4">
                                            ...
                                            <p className="text-xs text-gray-600 mb-2">Basic mortgage cover only</p>
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center gap-2 text-sm">
                                                ...
                                                <span className="text-gray-700">Limited death/disability coverage</span>
                                            </div>
                                            <div className="flex items-center gap-2 text-sm">
                                                <XCircle className="h-4 w-4 text-red-500 flex-shrink-0" />
                                                <span className="text-gray-700">No redundancy protection</span>
                                            </div>
                                            <div className="flex items-center gap-2 text-sm">
                                                <XCircle className="h-4 w-4 text-red-500 flex-shrink-0" />
                                                <span className="text-gray-700">Basic benefit amounts</span>
                                            </div>
                                            <div className="flex items-center gap-2 text-sm">
                                                <Timer className="h-4 w-4 text-red-500 flex-shrink-0" />
                                                <span className="text-gray-700">Long waiting periods</span>
                                            </div>
                                            <div className="flex items-center gap-2 text-sm">
                                                <TrendingDown className="h-4 w-4 text-red-500 flex-shrink-0" />
                                                <span className="text-gray-700">May not cover full mortgage</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-6 bg-gradient-to-br from-green-50 to-emerald-50 relative">
                                        ...
                                        <div className="text-center mb-4 mt-4">
                                            ...
                                            <p className="text-xs text-gray-600 mb-2">Comprehensive mortgage protection</p>
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-center gap-2 text-sm">
                                                ...
                                                <span className="text-gray-700">Full death/disability coverage</span>
                                            </div>
                                            <div className="flex items-center gap-2 text-sm">
                                                <Check className="h-4 w-4 text-green-500 flex-shrink-0" />
                                                <span className="text-gray-700">Redundancy protection included</span>
                                            </div>
                                            <div className="flex items-center gap-2 text-sm">
                                                <Check className="h-4 w-4 text-green-500 flex-shrink-0" />
                                                <span className="text-gray-700">Higher benefit amounts</span>
                                            </div>
                                            <div className="flex items-center gap-2 text-sm">
                                                <Check className="h-4 w-4 text-green-500 flex-shrink-0" />
                                            ...
                                            <div className="flex items-center gap-2 text-sm">
                                                <Check className="h-4 w-4 text-green-500 flex-shrink-0" />
                                                <span className="text-gray-700">Covers full mortgage amount</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-4 text-center border-t border-gray-200">
                                    <p className="text-sm text-gray-700 font-medium">
                                        💡 For just $20 more monthly, protect your home with comprehensive mortgage insurance
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                <p className="text-sm text-gray-600 font-medium">
                                    💡 For $20 more monthly, get comprehensive mortgage protection when you need it most
                                </p>
                            </motion.div>
                ...
                >
                    ...
                    <p className="text-xs text-gray-400 mt-4 max-w-2xl mx-auto">
                        *Figures are illustrative; your premium depends on age, mortgage risk, location, and chosen coverage level.
                    </p>
                </motion.div>
            </div>
        </section>
...
const MythBustingSection = () => {
    ...
    const myths = [
        {
            myth: "Mortgage insurance is too expensive",
        ...
        },
        {
            ...
            truth: "Mortgage events happen at any age. Join while healthy for lifetime benefits.",
        ...
        },
        {
            ...
            truth: "Public has long waits. Private gives you choice and speed for mortgage recovery.",
...
{(() => {
                ...
                >
                    <p className="text-lg text-gray-600 mb-6">
                        Ready to separate facts from fiction about your mortgage insurance options?
                    </p>
...
const HowItWorksSection = () => {
    ...
    const steps = [
        {
            icon: Stethoscope,
            title: "Tell us about your mortgage needs (2 minutes).",
            description: "Age, family size, current health status, coverage preferences - basic protection or comprehensive mortgage cover.",
        ...
        },
        {
            ...
            description: "Our team reviews your details against 15+ mortgage insurers and builds a shortlist tailored to your mortgage needs and budget.",
        ...
        },
        {
            ...
            description: "We'll contact you with your curated mortgage insurance options, explain waiting periods, and answer questions in plain English.",
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent mb-4">
                        How our NZ mortgage insurance comparison works
                    </h2>
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Get personalized mortgage insurance recommendations in 4 simple steps
                    </p>
                </motion.div>
                ...
                >
                    <p className="text-lg text-gray-600 mb-6">
                        Ready to find your perfect mortgage insurance match?
                    </p>
                    <motion.div
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
...
const StoriesSection = () => {
    ...
    const stories = [
        { 
            ...
            story: "When I was diagnosed with cancer, my mortgage insurance provided a lump sum that covered treatment costs and allowed me to focus on recovery without financial stress.",
        ...
        { 
            ...
            story: "After my heart attack, mortgage insurance gave us $100,000 immediately. It covered lost income during recovery and helped my family stay afloat financially.",
        ...
        { 
            ...
            story: "My stroke happened suddenly. Mortgage insurance paid out quickly, covering rehabilitation costs and allowing me to modify my home for recovery.",
                                        ...
                                        {activeStory < stories.length ? (
                                            ...
                                            >
                                                ...
                                                <p className="text-gray-600 mb-6">
                                                    Join thousands of Kiwis who found their perfect mortgage insurance with our help.
                                                </p>
                                                <motion.div
                                                    whileHover={{ scale: 1.05 }}
                                                    whileTap={{ scale: 0.95 }}
    ...
    const benefits = [
        {
            ...
            description: "A handpicked selection of mortgage insurance options from top NZ insurers tailored to your needs",
            gradient: "from-purple-500 to-pink-500",
            bgGradient: "from-purple-50 to-pink-50",
            icon: "🏆"
        },
        ...
        },
        {
            ...
            description: "We highlight the best value options based on your mortgage priorities, not just the cheapest price",
        ...
        },
        {
            ...
            description: "Personal advice from licensed mortgage insurance advisers at no extra cost to you",
            gradient: "from-green-500 to-teal-500",
            bgGradient: "from-green-50 to-teal-50",
            icon: "👥"
        },
        ...
        },
        {
            ...
            description: "Already have mortgage insurance? We'll review your existing policy and identify potential savings or better coverage options",
        ...
        <section ref={sectionRef} className="relative bg-gradient-to-br from-white via-purple-50/30 to-indigo-50/50 py-16 sm:py-24 overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        More than just quotes – a complete mortgage insurance experience designed around you
                    </p>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6 max-w-md mx-auto">
                            Get personalized mortgage insurance recommendations that actually make sense for your life and budget.
                        </p>
    ...
    return (
        <section className="bg-primary text-white py-16 sm:py-24">
            <div className="container mx-auto px-4 text-center max-w-7xl">
                ...
                <p className="text-lg text-primary-foreground/80 mb-8">Get personalized mortgage insurance quotes and expert guidance. Start your journey to better coverage today.</p>
...
const FaqSection = () => {
    const faqs = [
        { q: "What happens after I submit my details?", a: "We'll review your information, compare plans from top NZ mortgage insurers, and a dedicated adviser will contact you with tailored options. No instant quotes - we provide personalized recommendations." },
        { q: "Is the cheapest mortgage insurance always best?", a: "Not necessarily. The cheapest often has the most exclusions and lowest benefit amounts. We help you find the best value - the right coverage for your budget." },
        { q: "What's the difference between basic and comprehensive mortgage cover?", a: "Basic covers major mortgage events with lower benefits. Comprehensive includes more conditions, higher benefits, and partial payment options. We'll explain what each level includes." },
    ...
    return (
        <section className="bg-gray-50 py-16 sm:py-24">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold text-primary text-center mb-8">Mortgage insurance FAQs (NZ)</h2>

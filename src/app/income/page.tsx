                        ...
                        >
                            ...
                            >
                                <p className="text-sm text-gray-600 font-medium">
                                    💡 For $20 more monthly, save hundreds per year on routine incomecare
                                </p>
                            </motion.div>
...
const HowItWorksSection = () => {
    ...
    const steps = [
        {
            icon: Stethoscope,
            title: "1. Tell us about your income needs (2 minutes).",
    ...
    return (
        <section className="bg-primary text-white py-16 sm:py-24">
            <div className="container mx-auto px-4 text-center max-w-7xl">
                <h2 className="text-3xl font-bold mb-2">Ready to find the right income insurance?</h2>

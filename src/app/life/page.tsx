        ...
        <div className="grid grid-cols-2 gap-8 items-center">
          <div className="text-white">
            ...
            <p className="text-lg md:text-xl text-white mb-8 max-w-xl text-shadow">
              Find the right life cover for you and your family. Compare plans from leading NZ providers and get expert guidance.
            </p>
            <ul className="space-y-3">
               <li className="flex items-center text-lg gap-3">
                <Search className="h-6 w-6 text-green-400" />
                <span>Compare top NZ life insurers</span>
              </li>
               <li className="flex items-center text-lg gap-3">
  ...
  const sections = [
    {
      ...
      description: "Providers rate occupation, life, and age differently. A quick comparison can shave dollars off your monthly premium.",
      icon: Banknote,
            ...
            <div className="container mx-auto px-4 pt-16 pb-8">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-black">
                  Why compare life insurance quotes before you decide
                </h2>
              </motion.div>
            </div>
                    ...
                    <div className="lg:col-span-3 space-y-8">
                        ...
                        >
                            <h2 className="text-3xl md:text-4xl font-bold mb-4">
                                ...
                                life insurance isn't always the{' '}
                                <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
                                    best deal
                                </span>
                            </h2>
...
{(() => {
                        ...
                        >
                            ...
                            >
                                <p className="text-sm text-gray-600 font-medium">
                                    💡 For $20 more monthly, save hundreds per year on routine lifecare
                                </p>
                            </motion.div>
                ...
                >
                    ...
                    <p className="text-xs text-gray-400 mt-4 max-w-2xl mx-auto">
                        *Figures are illustrative; your premium depends on age, life status, location, and chosen coverage level.
                    </p>
                </motion.div>
            </div>
        </section>
...
const MythBustingSection = () => {
    ...
    const myths = [
        ...
        {
            myth: "I'm young and lifey, I don't need it",
            truth: "Accidents happen at any age. Join while lifey for lifetime benefits.",
        ...
        {
            myth: "Public lifecare covers everything",
...
{(() => {
                ...
                >
                    <p className="text-lg text-gray-600 mb-6">
                        Ready to separate facts from fiction about your life insurance options?
                    </p>
...
const HowItWorksSection = () => {
    ...
    const steps = [
        {
            icon: Stethoscope,
            title: "Tell us about your life needs (2 minutes).",
            description: "Age, family size, current life status, coverage preferences - GP visits, specialists, or comprehensive care.",
        ...
        },
        {
            ...
            description: "Our team reviews your details against 15+ life insurers and builds a shortlist tailored to your life needs and budget.",
        ...
        },
        {
            ...
            description: "We'll contact you with your curated life insurance options, explain waiting periods, and answer questions in plain English.",
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent mb-4">
                        How our NZ life insurance comparison works
                    </h2>
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Get personalized life insurance recommendations in 4 simple steps
                    </p>
                </motion.div>
                ...
                >
                    <p className="text-lg text-gray-600 mb-6">
                        Ready to find your perfect life insurance match?
                    </p>
                    <motion.div
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
...
const StoriesSection = () => {
    ...
    const stories = [
        { 
            ...
            story: "Needed surgery for a sports injury. Private life insurance meant I got treatment within 2 weeks instead of waiting 6 months publicly.",
        ...
        { 
            ...
            story: "Comprehensive cover includes dental and optical. Saves me $2000+ annually on regular life expenses.",
                                        ...
                                        {activeStory < stories.length ? (
                                            ...
                                            >
                                                ...
                                                <p className="text-gray-600 mb-6">
                                                    Join thousands of Kiwis who found their perfect life insurance with our help.
                                                </p>
                                                <motion.div
                                                    whileHover={{ scale: 1.05 }}
                                                    whileTap={{ scale: 0.95 }}
    ...
    const benefits = [
        {
            ...
            description: "A handpicked selection of life insurance options from top NZ insurers tailored to your needs",
            gradient: "from-purple-500 to-pink-500",
            bgGradient: "from-purple-50 to-pink-50",
            icon: "🏆"
        },
        ...
        },
        {
            ...
            description: "We highlight the best value options based on your life priorities, not just the cheapest price",
        ...
        },
        {
            ...
            description: "Personal advice from licensed life insurance advisers at no extra cost to you",
            gradient: "from-green-500 to-teal-500",
            bgGradient: "from-green-50 to-teal-50",
            icon: "👥"
        },
        ...
        },
        {
            ...
            description: "Already have life insurance? We'll review your existing policy and identify potential savings or better coverage options",
        ...
        <section ref={sectionRef} className="relative bg-gradient-to-br from-white via-purple-50/30 to-indigo-50/50 py-16 sm:py-24 overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        More than just quotes – a complete life insurance experience designed around you
                    </p>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-6 max-w-md mx-auto">
                            Get personalized life insurance recommendations that actually make sense for your life and budget.
                        </p>
...
const FaqSection = () => {
    const faqs = [
        { q: "What happens after I submit my details?", a: "We'll review your information, compare plans from top NZ life insurers, and a dedicated adviser will contact you with tailored options. No instant quotes - we provide personalized recommendations." },
        { q: "Is the cheapest life insurance always best?", a: "Not necessarily. The cheapest often has the most exclusions and longest waiting periods. We help you find the best value - the right coverage for your budget." },
        ...
        { q: "Can I get cover if I have life conditions?", a: "Often yes, but conditions may be excluded or have longer waiting periods. Some insurers are more flexible than others - we'll find your best options." },
        { q: "Do I need a medical exam?", a: "Depends on your age, life, and level of cover. Many applications are based on life questionnaires. We'll explain requirements upfront." },
        { q: "Can I cancel anytime?", a: "Most policies can be cancelled with 30 days notice. However, if you cancel and re-join later, you may face new waiting periods and life assessments." },
    ];

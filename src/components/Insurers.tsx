...
const logos = [
  ...
  { src: 'https://firebasestorage.googleapis.com/v0/b/quoteflow-insurance.firebasestorage.app/o/logo3rd.png?alt=media&token=8209efc4-1558-48f2-995e-8afee2809e59', alt: 'Insurance Company 3', hint: 'company logo' },

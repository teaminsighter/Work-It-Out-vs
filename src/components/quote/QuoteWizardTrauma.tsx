...
import { ALL_QUESTIONS } from '@/lib/questions-trauma';
...
export default function QuoteWizardTrauma() {
  ...
  const isSpecialPage = isHealthPage || isLifePage || isIncomePage || isTraumaPage;

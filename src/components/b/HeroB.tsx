      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start min-h-screen pt-40 pb-12">
          ...
          <div className="relative h-full hidden md:flex items-center justify-center">
            ...
            >
              <Card className="p-4 bg-white/30 backdrop-blur-md border-white/40 shadow-lg w-80 h-40 absolute top-1/4 left-0 -translate-x-1/4 rotate-[-10deg]">
              ...
              <Card className="p-4 bg-white/30 backdrop-blur-md border-white/40 shadow-lg w-80 h-40 absolute bottom-1/4 right-0 translate-x-1/4 rotate-[8deg]">
